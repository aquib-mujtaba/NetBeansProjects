...
<html lang="zxx">
    <head>
        <title>Esteem  An Admin Panel Category Flat Bootstrap Responsive Website Template | Form Validation  :: w3layouts</title>
        <!-- custom-theme -->
        ...
        <div class="wthree_agile_admin_info">
            ...
            <div class="w3_agileits_top_nav">
                <ul id="gn-menu" class="gn-menu-main">
                    ...
                    <li class="second logo"><h1><a href="main-page.jsp"><i class="fa fa-graduation-cap" aria-hidden="true"></i>Esteem </a></h1></li>
                        ...
                        <ul class="top_dp_agile ">
                            <li class="dropdown head-dpdn">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="#">
                                            <div class="user_img"><img src="resources/images/a3.jpg" alt=""></div>
                                    ...
                                    <li class="odd"><a href="#">
                                            <div class="user_img"><img src="resources/images/a1.jpg" alt=""></div>
                                            <div class="notification_desc">
                                                <h6>Jasmin Leo</h6>
                                                <p>Lorem ipsum dolor</p>
                                    ...
                                    <li><a href="#">
                                            <div class="user_img"><img src="resources/images/a2.jpg" alt=""></div>
                                            <div class="notification_desc">
                                                <h6>James Smith</h6>
                                                <p>Lorem ipsum dolor</p>
                                    ...
                                    <li><a href="#">
                                            <div class="user_img"><img src="resources/images/a4.jpg" alt=""></div>
                                            <div class="notification_desc">
                                                <h6>James Smith</h6>
                                                <p>Lorem ipsum dolor</p>
                                                <p><span>1 hour ago</span></p>
            ...
            <!-- input-forms -->
            <script type="text/javascript" src="resources/js/valida.2.1.6.min.js"></script>
