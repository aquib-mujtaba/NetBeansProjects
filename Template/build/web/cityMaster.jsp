        ...
        <div class="wthree_agile_admin_info">
            ...
            <div class="inner_content">
                ...
                <div class="inner_content_w3_agile_info two_in">
                    ...
                    <h2 class="w3_inner_tittle">City Master</h2>
                    <div class="graph-2 graph-form general agile_info_shadow">
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label for="selector1" class="col-sm-2 control-label">Select country</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control1 input-sm" id="smallinput" placeholder="Type Your City">
                                </div>
                            </div>
                            <div align="center">                 
                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><h5 id="h5.-bootstrap-heading">City ID<a class="anchorjs-link" href="#h5.-bootstrap-heading"><span class="anchorjs-icon"></span></a></h5></td>
                                            <td><h5 id="h5.-bootstrap-heading">City Name<a class="anchorjs-link" href="#h5.-bootstrap-heading"><span class="anchorjs-icon"></span></a></h5></td>
                                            <td><h5 id="h5.-bootstrap-heading">State<a class="anchorjs-link" href="#h5.-bootstrap-heading"><span class="anchorjs-icon"></span></a></h5></td>
