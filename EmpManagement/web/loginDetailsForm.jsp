                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <%!
                                                ...
                                                Statement st = null;
                                                ResultSet rs = null;
                                                String q = "select * from org.logintb";
                                                int count;
                                                String s1;
                                                String s2;
                                                String s3;
                                                ...
                                                <%
                                                    ...
                                                    <%
                                                        ...
                                                        {
                                                        %>
                                                    <td><span class="label label-admin"><%=s3%></span></td>
                                                        <%
                                                            }
                                                                                                           
                                                        else if(s3.equalsIgnoreCase("employee"))
                                                        {
                                                        %>
                                                    <td><span class="label label-employee"><%=s3%></span></td>
                                                        <%
                                                            }
                                                        if(b1==true)
                                                        {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            %>
                                                            <td>
                                                                <span class="badge badge-deactivated"></span><td><%=s4%></td>
                                                         <%
                                                        }
                                                        %>
